...
with open(os.path.join(OUT, "ranked_duct_cumming_v4.json"), "w", encoding="utf-8") as f:
    json.dump(res, f, indent=2, ensure_ascii=False)

with open(os.path.join(OUT, "ranked_duct_cumming_v4.csv"), "w", newline="", encoding="utf-8") as f:
    w = csv.writer(f)
